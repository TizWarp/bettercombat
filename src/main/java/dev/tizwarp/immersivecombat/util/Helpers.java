...
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.Animation;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.CustomAxe;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.CustomShield;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.CustomSword;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.CustomWeapon;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.CustomWeaponPotionEffect;
import dev.tizwarp.immersivecombat.util.ConfigurationHandler.SoundType;
...
public final class Helpers
{
	...
	public static boolean playerAttackVictimWithWeapon( EntityPlayer player, Entity entity, ItemStack mainhand, ItemStack offhand, boolean mainhandAttack )
	{
		...
		if (entity instanceof EntityPlayer && !weapon.isEmpty()) {

			damage = Math.pow(damage*ConfigurationHandler.player_damage_multiplier, 0.5) + 3.5;
			critDamage = Math.pow(critDamage*ConfigurationHandler.player_damage_multiplier, 0.5) + 3.5;
