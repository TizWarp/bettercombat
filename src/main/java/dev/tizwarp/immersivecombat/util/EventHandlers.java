...
import dev.tizwarp.immersivecombat.enchantment.EnchantmentWebbing;
import dev.tizwarp.immersivecombat.network.PacketHandler;
import dev.tizwarp.immersivecombat.network.PacketParried;
import dev.tizwarp.immersivecombat.network.PacketParrying;
import dev.tizwarp.immersivecombat.potion.BetterCombatPotions;
import dev.tizwarp.immersivecombat.potion.PotionAetherealized;
	...
	public void adjustBowTicksStart(LivingEntityUseItemEvent.Start event)
	{
		if (event.getEntityLiving() instanceof EntityPlayer)
		{
			...
			if (heldItem.getItem() instanceof ItemBow)
			{
				...
				for (ConfigurationHandler.CustomBow CustomBow : ConfigurationHandler.bows)
				{
