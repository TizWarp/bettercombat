			...
			if ( !isShield(currentOffhandItem) && isWeapon(currentOffhandItem) )
			{
				...
				for ( ConfigurationHandler.CustomWeapon weapon : ConfigurationHandler.weapons )
				{
					if ( s.contains(weapon.name) )
					{
						...
						if ( weapon.property == ConfigurationHandler.WeaponProperty.TWOHAND || weapon.property == ConfigurationHandler.WeaponProperty.MAINHAND )
						{
			...
			if ( isWeapon(currentMainhandItem.weapon) )
			{
				...
				for ( ConfigurationHandler.CustomWeapon weapon : ConfigurationHandler.weapons )
				{
					if ( s.contains(weapon.name) )
					{
						...
						if ( weapon.property == ConfigurationHandler.WeaponProperty.TWOHAND )
						{
							/* No changes */
							return;
						}
